  ...
  var WrappedRange = /** @class */ (function () {
      ...
      WrappedRange.prototype.normalize = function () {
          ...
          var getVisiblePoint = function (point, isLeftToRight) {
              ...
              //  - caseinfo 01. if the point is on the middle of the node
              //  - caseinfo 02. if the point is on the right edge and prefer to choose left node
              //  - caseinfo 03. if the point is on the left edge and prefer to choose right node
              //  - caseinfo 04. if the point is on the right edge and prefer to choose right node but the node is void
              //  - caseinfo 05. if the point is on the left edge and prefer to choose left node but the node is void
              //  - caseinfo 06. if the point is on the block node and there is no children
  ...
  var range = {
      ...
      createFromSelection: function () {
          ...
          if (env.isW3CRangeSupport) {
              ...
              // same visible point caseinfo: range was collapsed.
