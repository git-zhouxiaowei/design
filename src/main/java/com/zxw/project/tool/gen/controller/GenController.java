package com.zxw.project.tool.gen.controller;
...
import com.zxw.framework.web.domain.CxSelect;
...
import com.zxw.project.tool.gen.service.IGenTableColumnService;
import com.zxw.project.tool.gen.service.IGenTableService;
...
public class GenController extends BaseController {
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"zxw.zip\"");
